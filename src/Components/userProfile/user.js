...
const User = () => {
  ...
  return (
    ...
    <li x-for="item in items">
      ...
      {/* <section className="unpinned-card-area">
      <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4">
     {
        unpinnedCards.map(unpinitem =>(
    <li x-for="item in items">
      <a href="item.url" className="shadow-md hover:bg-light-blue-500 hover:border-transparent hover:shadow-lg group block rounded-lg p-4 border border-gray-200 bg-white">
        <dl className="grid sm:block lg:grid xl:block grid-cols-2 grid-rows-2 items-start h-40">
          <div className="">
